        ...
        <main class="container main">
            <div class="row">
                <article class="col col__article">
                    ...
                    <h2>Установка программы SA-OKNA (рабочая версия).</h2>
                    <p> &nbsp;Для начала вам необходимо получить установщик программы у вашего поставщика услуг.
                        Установщик состоит из 3х файлов, которые надо располохить в папке из которой вы будите запускать программу.
                ...
                <aside class="col col__aside"
                    ...
                    <br><br>    
                    <p><a href="https://youtu.be/U3841muhW1Q">Смотреть видио<br>YouTube</a></p>
                    <br>
